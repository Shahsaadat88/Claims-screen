...
const AddClaim = () => {
    ...
    <form className="addClaimForm"> 
      ...
      <input type="text" required="true" id="policyNumber" value={newClaim.policyNumber} onChange= {handleChange}/>
      <br/>
      <label htmlFor="date">Date of the Event*</label>
      <input type="date" required="true" id="date" value={newClaim.date} onChange= {handleChange}/>
      <br/>
      ...
      <input type="text" required="true" id="firstName" value={newClaim.firstName} onChange= {handleChange}/>
      <br/>
      <label htmlFor="lastName">Last Name</label>
      <input type="text" required="true" id="lastName" value={newClaim.lastName} onChange= {handleChange}/>
      <br/>
      <label htmlFor="dob">Date of Birth</label>
      <input type="date" required="true" id="dob" value={newClaim.dob} onChange= {handleChange}/>
      <br/>
      <label htmlFor="description">Please describe reason for Claim</label>
      <br/>
      <textarea  required="true" id="description" value={newClaim.description} onChange= {handleChange}/>
      <br/>
